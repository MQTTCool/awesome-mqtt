...
* [EnMasse](https://github.com/EnMasseProject/enmasse) - self-service messaging platform on Kubernetes and OpenShift with a uniform interface to manage different messaging infrastructure (supports AMQP 1.0, MQTT, OpenWire, CORE and STOMP). 
